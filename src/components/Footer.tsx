  ...
  return (
    <footer className="py-12 bg-secondary/50 relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute bottom-0 left-1/4 w-64 h-64 rounded-full bg-blue-500/5 filter blur-3xl"></div>
        <div className="absolute top-0 right-1/3 w-64 h-64 rounded-full bg-purple-500/5 filter blur-3xl"></div>
      </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-center md:text-left text-muted-foreground text-sm">
              © {new Date().getFullYear()} Imshn. All rights reserved.
            </div>
            ...
            <div className="flex gap-4">
              ...
              <a
                href="https://twitter.com/anaminind"
                className="text-muted-foreground hover:text-primary transition-colors"
                aria-label="Twitter"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16">

  ...
  return (
    <section id="contact" ref={sectionRef} className="py-24 relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 right-0 w-96 h-96 rounded-full bg-blue-500/10 filter blur-3xl"></div>
        <div className="absolute bottom-0 left-0 w-96 h-96 rounded-full bg-purple-500/10 filter blur-3xl"></div>
      </div>
              ...
              <form onSubmit={handleSubmit} className="glass-card p-6 rounded-xl">
                <div className="space-y-5">
                  ...
                  <Button 
                    type="submit"
                    className={cn(
                      "w-full py-6 flex items-center justify-center gap-2 transition-all",
              ...
              <div className="glass-card p-6 rounded-xl h-full flex flex-col justify-between">
                ...
                <div className="mt-8">
                  ...
                  <div className="flex gap-3">
                    <a 
                      href="https://github.com/imshn" 
                      className="p-3 rounded-full bg-secondary/50 hover:bg-primary hover:text-white transition-all"
                      aria-label="GitHub"
                    >
                    ...
                    <a 
                      href="https://www.instagram.com/__i.am.shaan__/" 
                      className="p-3 rounded-full bg-secondary/50 hover:bg-primary hover:text-white transition-all"
